 ...
 * These types serve as the formal API contract between components and will be
 * implemented in src/types/panel.ts during Phase 2.
 */
...
export interface UseSignalListReturn {
	/** Map of all signal entries by ID */
	signalEntries: Map<string, SignalEntry>;

	/** Array of all signal entries */
	signals: SignalEntry[];
