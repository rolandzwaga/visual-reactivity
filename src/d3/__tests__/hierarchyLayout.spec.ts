...
describe("hierarchyLayout", () => {
	describe("createHierarchyLayout", () => {
		...
		it("should use default separation multiplier for siblings", () => {
			...
			const parent = {} as any;
			const siblingsA = { parent, depth: 1 } as any;
			const siblingsB = { parent, depth: 1 } as any;
		...
		it("should use increased separation multiplier for non-siblings", () => {
			...
			const nodeA = { parent: {} as any, depth: 1 } as any;
			const nodeB = { parent: {} as any, depth: 1 } as any;
